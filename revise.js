...
// // Q. Print the table of given number in reverse order

// let n = prompt("Enter the number to print table in reverse order: ");
// for(let i=10; i>=1; i--){
//     console.log(`${n} * ${i} = ${n*i}`);
// }
...
contactBtn.addEventListener('click', function() {
    // This message will appear when the button is clicked
    alert("Hello! Thank you for reaching out to Aarav Desai. This is an interactive demo.");
});